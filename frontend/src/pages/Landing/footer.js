            ...
            <footer id="footer" className="relative z-50 dark:bg-gray-900">
                        ...
                        <div className="lg:flex">
                            <div className="w-full lg:w-1/2 mb-16 lg:mb-0 flex">
                                <div className="w-full lg:w-1/2 px-6">
                                    <ul>
                                        <li>
                                            <NavLink to="javascript:void(0)" className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">
                                                Components
                                            </NavLink>
                                        </li>
                                        <li className="mt-6">
                ...
                <div className="py-16 flex flex-col justify-center items-center">
                    {/* <NavLink to="javascript:void(0)"> */}
                        <h1 className="titleLogo text-center font-bold text-5xl">trackr</h1>
                    {/* </NavLink> */}
                    <p className="mt-6 text-xs lg:text-sm leading-none text-gray-900 dark:text-gray-50">© 2021. All Rights Reserved.</p>
                </div>
            </footer>
        </div>
    );
